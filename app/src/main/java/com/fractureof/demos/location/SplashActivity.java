...
//            Syncano.init("83d5b6d706b3584108ac8c543a0b4809c9a4a8a5", "polished-night-6282");
    ...
    public static String temp_me_geo_id = "EjvXoNeX15zXqiDXkdeg15nXnteZ158gMTE1LCDXqtecINeQ15HXmdeRINeZ16TXlSwg15nXqdeo15DXnA";
    public static String temp_me_geo_location_text = "נחלת בנימין 115, תל אביב יפו, ישראל";
    public static LatLng temp_me_latLng = new LatLng(32.0588066f,34.7722388f);
    ...
    public static float temp_me_lat = 32.0588066f;
    public static float temp_me_lng = 34.7722388f;
